      ...
      <form onSubmit={handleSubmit} className="space-y-3" noValidate>
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`vivid-input block w-full rounded-2xl pl-11 pr-4 py-2.5 text-sm text-slate-900 placeholder-slate-400 font-body ${
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="••••••••"
              className={`vivid-input block w-full rounded-2xl pl-11 pr-12 py-2.5 text-sm text-slate-900 placeholder-slate-400 font-body ${
        ...
        <div className="flex items-center justify-between pt-1 font-body">
          ...
          <a
            ...
            onClick={(e) => {
              e.preventDefault();
              showToast("Función para restablecer contraseña próximamente.");
            }}
